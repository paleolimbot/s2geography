...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        LineInterpolatePointParam{"zero_length_line_z",
                                  ...
                                  "POINT Z (1 1 10)"},
        LineInterpolatePointParam{"zero_length_line_m",
                                  "LINESTRING M (1 1 10, 1 1 10)", 0.5,
                                  "POINT M (1 1 10)"},
        LineInterpolatePointParam{"zero_length_line_zm",
                                  "LINESTRING ZM (1 1 10 20, 1 1 10 20)", 0.5,
                                  "POINT ZM (1 1 10 20)"},
        ...
        LineInterpolatePointParam{"midpoint_z", "LINESTRING Z (0 0 10, 0 2 12)",
                                  0.5, "POINT Z (0 1 11)"},
        LineInterpolatePointParam{"start_m", "LINESTRING M (0 0 10, 0 2 12)",
                                  0.0, "POINT M (0 0 10)"},
        LineInterpolatePointParam{"end_m", "LINESTRING M (0 0 10, 0 2 12)", 1.0,
                                  "POINT M (0 2 12)"},
        LineInterpolatePointParam{"midpoint_m", "LINESTRING M (0 0 10, 0 2 12)",
                                  0.5, "POINT M (0 1 11)"},
        LineInterpolatePointParam{"start_zm",
                                  "LINESTRING ZM (0 0 10 20, 0 2 12 22)", 0.0,
                                  "POINT ZM (0 0 10 20)"},
        LineInterpolatePointParam{"end_zm",
                                  "LINESTRING ZM (0 0 10 20, 0 2 12 22)", 1.0,
                                  "POINT ZM (0 2 12 22)"},
        LineInterpolatePointParam{"midpoint_zm",
                                  "LINESTRING ZM (0 0 10 20, 0 2 12 22)", 0.5,
                                  "POINT ZM (0 1 11 21)"},
        ...
        LineInterpolatePointParam{"multi_seg_three_quarter_z",
                                  ...
                                  "POINT Z (0 1.5 11.5)"},
        LineInterpolatePointParam{"multi_seg_quarter_m",
                                  "LINESTRING M (0 0 10, 0 1 11, 0 2 12)", 0.25,
                                  "POINT M (0 0.5 10.5)"},
        LineInterpolatePointParam{"multi_seg_three_quarter_m",
                                  "LINESTRING M (0 0 10, 0 1 11, 0 2 12)", 0.75,
                                  "POINT M (0 1.5 11.5)"},
        LineInterpolatePointParam{
            "multi_seg_quarter_zm",
            "LINESTRING ZM (0 0 10 20, 0 1 11 21, 0 2 12 22)", 0.25,
            "POINT ZM (0 0.5 10.5 20.5)"},
        LineInterpolatePointParam{
            "multi_seg_three_quarter_zm",
            "LINESTRING ZM (0 0 10 20, 0 1 11 21, 0 2 12 22)", 0.75,
        ...
        LineInterpolatePointParam{"fraction_one_z",
                                  ...
                                  "POINT Z (0 2 12)"},
        LineInterpolatePointParam{"fraction_zero_m",
                                  "LINESTRING M (0 0 10, 0 2 12)", 0.0,
                                  "POINT M (0 0 10)"},
        LineInterpolatePointParam{"fraction_one_m",
                                  "LINESTRING M (0 0 10, 0 2 12)", 1.0,
                                  "POINT M (0 2 12)"},
        LineInterpolatePointParam{"fraction_zero_zm",
                                  "LINESTRING ZM (0 0 10 20, 0 2 12 22)", 0.0,
                                  "POINT ZM (0 0 10 20)"},
        LineInterpolatePointParam{"fraction_one_zm",
                                  "LINESTRING ZM (0 0 10 20, 0 2 12 22)", 1.0,
                                  "POINT ZM (0 2 12 22)"},
